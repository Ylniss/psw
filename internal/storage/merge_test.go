...
func TestMergeRecords_CaseInsensitiveDedup_RemoteNewerWins(t *testing.T) {
	fork := []Record{}
	local := []Record{
		{Name: "alice", Username: "u", Password: "fromA", MTime: 100},
	}
	remote := []Record{
		{Name: "ALICE", Username: "u", Password: "fromB", MTime: 200},
	}
...
func TestMergeRecords_CaseInsensitiveDedup_LocalNewerWins(t *testing.T) {
	fork := []Record{}
	local := []Record{
		{Name: "ALICE", Username: "u", Password: "fromA", MTime: 200},
	}
	remote := []Record{
		{Name: "alice", Username: "u", Password: "fromB", MTime: 100},
	}
